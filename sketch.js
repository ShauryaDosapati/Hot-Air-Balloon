...
var score = 0;// game statesvar PLAY = 1;var END = 0;var gameState = PLAY;function preload() {
...
dieSound = loadSound("assets/die.mp3");}function setup() {
...
restart.visible = false;}function draw() {


if (gameState === PLAY) { // making the hot air balloon jump
    if (keyDown("space")) {
        balloon.velocityY = -6;
        jumpSound.play();
    }
...
score = 0;}function spawnObstaclesTop() {
...
textSize(30);
fill("yellow");
text("Score: " + score, 250, 50);}// using API calls to set the background image according to timeasync function getBackgroundImg() {
